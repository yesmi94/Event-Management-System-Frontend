...
import { Search, Calendar, Filter, RefreshCw, Trash2, AlertTriangle } from "lucide-react";
                    ...
                    <div className="max-w-2xl mx-auto mt-8">
                        <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 flex items-center gap-3">
                            ...
                            <p className="text-red-300 text-sm">
                                <strong>Warning:</strong> Deleting an event is permanent and cannot be undone. All associated registrations will also be removed.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/40">
                        ...
                        <div className="mt-4 flex flex-wrap gap-4 text-sm text-gray-400">
                            <div className="flex items-center gap-2">
                                <span>{filteredEvents.length} Events Available for Deletion</span>
                            </div>
                            {searchTerm && (
                                <div className="flex items-center gap-2">
                                ...
                                <div className="text-center py-20">
                                    <div className="max-w-md mx-auto">
                                        ...
                                        <h3 className="text-2xl font-semibold text-white mb-4">
                                            {searchTerm ? 'No matching events found' : 'No events available for deletion'}
                                        </h3>
                    ...
                    >
                        <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                                <div>
                                    <div className="text-3xl font-bold text-red-400 mb-2">{filteredEvents.length}</div>
