...
const EventActionsPage = () => {
  ...
  const actions = [
    {
      title: "Create Event",
      description: "Organize and publish a new event with custom details and settings.",
      ...
      <div className="relative z-10 p-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Choose from our powerful event management tools to create, organize, and manage your events
          </p>
                ...
                <CardContent>
                  ...
                  <div className="mt-8 flex items-center justify-between">
                    <div className="flex space-x-1">
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${action.color} opacity-60 group-hover:opacity-100 transition-opacity duration-300`}></div>
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${action.color} opacity-40 group-hover:opacity-80 transition-opacity duration-300 delay-75`}></div>
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${action.color} opacity-20 group-hover:opacity-60 transition-opacity duration-300 delay-150`}></div>
                    </div>
